    ...
    App::new("gpxanalyzer")
        ...
        .subcommand(SubCommand::with_name("analyze")
            ...
            .arg(Arg::with_name("distance")
                ...
                .help("Find best time for a fixed distance (ex 1km: or 100m)")
                .takes_value(true))
            .arg(Arg::with_name("time")
                .short("t")
                .long("time")
                .value_name("DURATION_THRESHOLD")
                .help("Find best distance for a fixed time (ex: 00:10:00 for 10 minutes)")
                .takes_value(true)
